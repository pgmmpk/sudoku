...
const COLS = DIGITS;       // Column lables
const SQUARES = _cross(ROWS, COLS);             // Square IDs

const UNITS = _get_all_units(ROWS, COLS);               // All units (row, column, or box)
const SQUARE_UNITS_MAP = _get_square_units_map(SQUARES, UNITS);    // Squares -> units map
const SQUARE_PEERS_MAP = _get_square_peers_map(SQUARES, SQUARE_UNITS_MAP);    // Squares -> peers map
...
export function board_grid_to_string(board_grid) {
