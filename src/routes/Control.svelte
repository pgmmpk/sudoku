...
<div class="mt-4 select-none flex flex-col items-center justify-center touch-none">
    <div class="mt-4 grid grid-cols-5 items-center justify-center sized">
        ...
        <button use:superclick={() => haptic(onUndo())} aria-label="undo">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 inline-block">
                <path stroke-linecap="round" stroke-linejoin="round" d="M9 15 3 9m0 0 6-6M3 9h12a6 6 0 0 1 0 12h-3" />
            </svg>
        </button>
        <button use:superclick={() => haptic((fill = !fill))} class:bg-gray-300={!fill} aria-label="mode">
        ...
        <button use:superclick={() => haptic(onPause())} aria-label="pause">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 inline">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 5.25v13.5m-7.5-13.5v13.5" />
            </svg>
        </button>
        <button use:superclick={() => haptic(onShowSettings())} aria-label="settings">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 inline">
